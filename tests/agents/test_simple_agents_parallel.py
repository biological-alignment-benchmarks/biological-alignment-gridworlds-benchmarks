...
def test_randomwalkagent_in_savanna_zoo_parallel(tparams_hparams: Dict) -> None:
...
def test_randomwalkagent_in_savanna_gridworlds_parallel(tparams_hparams: Dict) -> None:
    full_params = tparams_hparams
    params_randomwalkagent = {
        "agent": "random_walk_agent",
